...
def evaluate_quiz(
    ...
    # Create Quiz Attempt
    quiz_attempt = quiz_attempt_repository.create_quiz_attempt(
        db,
        QuizAttemptCreate(
    ...
    for answer in submission.answers:
        ...
        is_correct = (
            answer.selected_answer_option_id
            == correct_answer.id
        )
    ...
    question_attempt_repository.create_question_attempts(
        db,
        question_attempts,
    )

    # Update Quiz Attempt
    quiz_attempt_repository.complete_quiz_attempt(
        db,
        quiz_attempt,
        score,
        total_questions,
